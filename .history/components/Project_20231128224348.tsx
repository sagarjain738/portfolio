...
export function Project({ description, imageUrl, tags, title }: ProjectProps) {
  ...
  return (
    ...
    >
      <section className="bg-gray-100 hover:bg-gray-200 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] transition group-even:pl-6">
