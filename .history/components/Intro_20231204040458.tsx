...
const Intro: React.FC<IntroProps> = () => {
  const { ref } = useSectionInView({ activeSection: "Home", threshold: 0.5 });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href={"#contact"}
          className="group bg-gray-950 text-white px-[1.4rem] py-3 flex justify-center items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-100 transition-all"
          onClick={() => {
        ...
        <a
          ...
          dark:bg-white/10 dark:backdrop-blur-[0.5rem] bg-opacity-40
          "
        >
          Download CV
