  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href={"#contact"}
          className="group bg-gray-950 text-white px-6 py-3 flex justify-center items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-100 transition-all"
        >
          Contact Me Here{" "}
        ...
        <a
          href={"/CV.pdf"}
          download
          className="group text-gray-950 bg-white px-6 py-3 flex justify-center items-center gap-2 rounded-full shadow-2xl
