...
function Contact({}: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <input
          className="h-14 px-4 roundel-lg border border-black/10 first-letter:
          dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:text-black
          "
          type="email"
