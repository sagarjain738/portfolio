  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <Link
          href={"#contact"}
          className="bg-gray-950 text-white px-7 py-3 flex justify-center items-center gap-2 rounded-full outline-none scale-100 focus-visible:scale-100 focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-100 transition-all"
        >
