  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        . I am also familiar with TypeScript, C#, .NET & SQLServer. My journey
        in software development has equipped me with a keen understanding of
        both front-end and back-end technologies, allowing me to seamlessly
        bridge the gap between design and functionality. I am always looking to
