...
export function Project({ description, imageUrl, tags, title }: ProjectProps) {
  return (
    <motion.section className="bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative mb-3 sm:mb-8 last:mb-0 sm:h-[20rem] group even:pl-12 hover:bg-gray-200 transition">
