  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      <div className="flex justify-center items-center gap-4">
        ...
        <a
          href={"#contact"}
          className="text-gray-950 bg-white px-7 py-3 flex justify-center items-center gap-2 rounded-full shadow-2xl font-bold "
        >
          Download CV <HiDownload />
        </a>
        {/* Linked-In */}
        <a className="text-gray-950 bg-white p-4 flex justify-center items-center gap-2 rounded-full shadow-2xl font-bold ">
          <BsLinkedin />
        </a>

        {/* Git Hub */}
        <a className="text-gray-950 text-2xl bg-white p-4 flex justify-center items-center gap-2 rounded-full shadow-2xl font-bold ">
          <FaGithubSquare />
        </a>
      </div>
    </section>
