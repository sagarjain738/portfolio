...
export function Project({ description, imageUrl, tags, title }: ProjectProps) {
  ...
  return (
    <motion.div
      ...
      className="mb-3 sm:mb-8 last:mb-0 group hover:bg-gray-200 "
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] transition">
