...
function Header({ name }: HeaderProps) {
    return (
        <header className="z-[999] relative">
            ...
            ></motion.div>
            <nav className="flex justify-between items-center fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
                <ul className="flex justify-between items-center bg-red-200">
                    {
